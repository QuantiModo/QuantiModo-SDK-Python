...
class Permission(object):
    ...
    def min_timestamp(self, min_timestamp):
        ...
        if min_timestamp is None:
            raise ValueError("Invalid value for `min_timestamp`, must not be `None`")
    ...
    def max_timestamp(self, max_timestamp):
        ...
        if max_timestamp is None:
            raise ValueError("Invalid value for `max_timestamp`, must not be `None`")
    ...
    def min_time_of_day(self, min_time_of_day):
        ...
        :type: int
        """
        if min_time_of_day is None:
            raise ValueError("Invalid value for `min_time_of_day`, must not be `None`")
    ...
    def max_time_of_day(self, max_time_of_day):
        ...
        :type: int
        """
        if max_time_of_day is None:
            raise ValueError("Invalid value for `max_time_of_day`, must not be `None`")
