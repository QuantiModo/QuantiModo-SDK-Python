...
class AuthenticationApi(object):
    ...
    def v2_oauth_authorize_get(self, client_id, client_secret, response_type, scope, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str client_id: This is the unique ID that QuantiModo uses to identify your application. Obtain a client id by creating a free application at [https://app.quantimo.do/api/v2/apps](https://app.quantimo.do/api/v2/apps). (required)
        :param str client_secret: This is the secret for your obtained clientId. QuantiModo uses this to validate that only your application uses the clientId.  Obtain this by creating a free application at [https://app.quantimo.do/api/v2/apps](https://app.quantimo.do/api/v2/apps). (required)
