...
class OauthApi(object):
    ...
    def oauth2_accesstoken_get(self, response_type, redirect_uri, realm, client_id, scope, state, **kwargs):
        ...
        query_params = remove_none(dict(response_type=params.get('response_type'), redirect_uri=params.get('redirect_uri'), realm=params.get('realm'), client_id=params.get('client_id'), scope=params.get('scope'), state=params.get('state')))
    ...
    def oauth2_authorize_get(self, client_id, realm, redirect_uri, response_type, scope, state, **kwargs):
        ...
        path_params = remove_none(dict())
        query_params = remove_none(dict(client_id=params.get('client_id'), realm=params.get('realm'), redirect_uri=params.get('redirect_uri'), response_type=params.get('response_type'), scope=params.get('scope'), state=params.get('state')))
        header_params = remove_none(dict())
        form_params = remove_none(dict())
        files = remove_none(dict())
        body_params = None
