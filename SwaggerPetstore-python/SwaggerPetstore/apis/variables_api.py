...
class VariablesApi(object):
    ...
    def correlations_post(self, cause, effect, correlationcoefficient, vote, **kwargs):
        ...
        query_params = remove_none(dict(cause=params.get('cause'), effect=params.get('effect'), correlationcoefficient=params.get('correlationcoefficient'), vote=params.get('vote')))
    ...
    def variable_user_settings_post(self, sharing_data, **kwargs):
        ...
        :param list[VariableUserSettings] sharing_data: Variable user settings data (required)
        ...
        form_params = remove_none(dict())
        files = remove_none(dict())
        body_params = params.get('sharing_data')
    ...
    def variables_get(self, **kwargs):
        ...
        path_params = remove_none(dict())
        query_params = remove_none(dict(userId=params.get('user_id'), categoryName=params.get('category_name')))
        header_params = remove_none(dict())
        form_params = remove_none(dict())
        files = remove_none(dict())
        body_params = None
    ...
    def variables_post(self, variable_name, **kwargs):
        ...
        :param list[Variable] variable_name: Original name for the variable. (required)
        ...
        form_params = remove_none(dict())
        files = remove_none(dict())
        body_params = params.get('variable_name')
    ...
    def variables_search_search_get(self, search, **kwargs):
        ...
        path_params = remove_none(dict(search=params.get('search')))
        query_params = remove_none(dict(categoryName=params.get('category_name'), source=params.get('source'), limit=params.get('limit'), offset=params.get('offset')))
        header_params = remove_none(dict())
        form_params = remove_none(dict())
        files = remove_none(dict())
        body_params = None
