...
class TestMeasurementsApi(unittest.TestCase):
    ...
    def test_v2_measurements_id_delete(self):
        """
        Test case for v2_measurements_id_delete

        Delete Measurement
        """
        pass

    def test_v2_measurements_id_get(self):
        """
        Test case for v2_measurements_id_get

        Get Measurement
        """
        pass

    def test_v2_measurements_id_put(self):
        """
        Test case for v2_measurements_id_put
