...
class UnitsApi(object):
    ...
    def v1_units_get_with_http_info(self, **kwargs):
        ...
        all_params = ['access_token', 'id', 'unit_name', 'abbreviated_unit_name', 'category_name']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
    ...
    def v1_units_variable_get_with_http_info(self, **kwargs):
        ...
        all_params = ['access_token', 'unit_name', 'abbreviated_unit_name', 'category_name', 'variable']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
